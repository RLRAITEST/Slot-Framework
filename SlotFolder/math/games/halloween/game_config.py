...
class GameConfig(Config):
    ...
    def __init__(self):
        super().__init__()
        self.game_id = "halloween"
        self.provider_number = 0
        self.working_name = "Halloween"
        self.wincap = 20000.0
        self.win_type = "cluster"
        self.rtp = 0.9650
        self.tumble_step_cap = 100
        self.max_total_fs = 100
        ...
        def fs_award(scatter_count: int) -> int:
            if scatter_count <= 4:
                return 10
            if scatter_count == 5:
                return 12
            if scatter_count == 6:
                return 14
            return 14 + 2 * (scatter_count - 6)

        fs_table = {n: fs_award(n) for n in range(4, 50)}
        self.freespin_triggers = {
            self.basegame_type: dict(fs_table),
            self.freegame_type: dict(fs_table),
        }
        ...
        mode_maxwins = {"base": 20000, "bonus": 20000}
