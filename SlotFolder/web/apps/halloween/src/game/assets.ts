export default {
	...
	'slot-background.png': {
		type: 'sprite',
		src: new URL('../../assets/sprites/background/slot-background.png', import.meta.url).href,
	},
	'slot-ramme-nobg.png': {
		type: 'sprite',
		src: new URL('../../assets/sprites/reelsFrame/slot-ramme-nobg.png', import.meta.url).href,
	},
	'slot-logo.png': {
		type: 'sprite',
		src: new URL('../../assets/sprites/logo/slot-logo.png', import.meta.url).href,
		preload: true,
	},
	coins: {
		type: 'spriteSheet',
